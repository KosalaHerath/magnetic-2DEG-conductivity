...
\begin{equation} \label{eq:c6}
  ...
  t \leq t_0.
\end{equation}
Next, we can move our analysis into the interaction picture representation \cite{bruus04,mahan00} and in the interaction picture, the $t$-$t'$-Floquet state can be identified as
...
\begin{figure}[b]
  ...
  \label{fig:2}
\end{figure}
This scenario is illustrated in Fig.~\ref{fig:2}.
The scattering amplitude for this scattering scenario can be calculated using the expression derived in Eq.~(\ref{eq:c14}) as follows
...
\begin{equation} \label{eq:c31}
  ...
  \end{aligned}
\end{equation}
Finally, the scattering amplitude derived in Eq.~(\ref{eq:c17}) can be evaluated for given $k_x = 2\pi m_{\alpha}/L_x$ and $k'_x =  2\pi m_{\beta}/L_x$ as
...
\begin{equation} \label{eq:c38}
  \begin{aligned}
      ...
      \int_{-\infty}^{\infty}
      {\chi}_{n_{\beta}}(y)
      {\chi}_{n_{\beta}}(y_0 - {y'}_0 - y) dy \right|^2.
  \end{aligned}
\end{equation}
...
\begin{equation} \label{eq:42}
  \begin{aligned}
    ...
    & \quad\times
    \int_{-\infty}^{\infty} \left\{
    J_l\bm{(}\frac{b\hbar}{eB}[{k}_x - {k'}_x]\bm{)}
    J_{l'}\bm{(}\frac{b\hbar}{eB}[{k}_x - {k'}_x]\bm{)} \right. \\
    & \left. \qquad\times
    \left|
    \int_{-\infty}^{\infty}
    {\chi}_{n_{\beta}}(y)
    {\chi}_{n_{\beta}} \bm{\left(}\frac{\hbar}{eB} ({k'}_x - {k}_x) - y \bm{\right)} dy\right|^2 \right\} d {k'}_x.
  \end{aligned}
\end{equation}
