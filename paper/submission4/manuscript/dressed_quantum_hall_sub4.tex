...
\begin{equation} \label{eq:38}
  ...
  \end{aligned}
\end{equation}
where $\varsigma = \flatfrac{\Gamma_0}{(2\hbar \omega_0)}$. Here, $\Gamma_0$ is the natural energy broadening of the least Landau level. The derived analytical expression is further analyzed numerically using empirical system parameters to compare with the results from previous charge transport studies on quantum Hall systems. For the interested reader, the full \textsc{mathematica} codes for the simulations are available in Ref.~\cite{supplemental1}.
