...
Then performing Fourier transform over the confined two-dimentional space, we obtain the momentum space($k_x,k_y$) representation of Floquet modes
...
\end{equation}
For details of the full derivation please refer to Appendix B. Now using Floquet theory, the wave functions derived in Eq.~(\ref{eq_2}) can be written in momentum space as Floquet states
