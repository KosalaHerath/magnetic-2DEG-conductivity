...
\end{equation}
with eigenvalues $\epsilon_n = \hbar \omega_0 (n + 1/2)$ where $\omega_0 = eB/m_e$ is the cyclotron frequency. The path shift of the driven classical oscillator $\zeta(t)$ is given by
