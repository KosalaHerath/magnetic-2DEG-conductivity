...
\end{equation}
where eigenvalues are given by $\varepsilon_n = \hbar \omega_0 (n + 1/2)$ and $\omega_0 \equiv eB/m_e$ is the cyclotron frequency. Each $n$ value defines the occupied energy($\varepsilon_n$) of the respective Landau level. The path shift of the driven classical oscillator $\zeta(t)$ is given by
