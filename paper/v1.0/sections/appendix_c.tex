...
\begin{equation} \label{eq_c8}
  ...
  V(\vb{r}).
\end{equation}
This leads to the $t$-$t'$-Schrödinger equation in the interaction picture
...
\end{equation}
and performing the time derivation of each matrix element yield the \textit{transition amplitude matrix}:
