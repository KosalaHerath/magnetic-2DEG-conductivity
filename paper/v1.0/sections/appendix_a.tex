...
\begin{equation} \label{eq_a5}
    ...
    \bigg) \phi(\tilde{y},t),
\end{equation}
where $\phi(\tilde{y},t)$ is a function that need to be find to satisfy the following property
...
\begin{equation} \label{eq_a18}
  ...
  \end{aligned}
\end{equation}
The set $\{\chi_n(x)\}$ functions forms a complete set and thus any general solution $\phi_(\tilde{y},t)$ can be expaned in terms of the solutions given in Eq.~(\ref{eq_a18}).
