...
% \input{sections/4_floquet_fermi_golden.tex}

\section{Inverse Scattering Time Analysis}
\input{sections/5_inverse_scattering_time.tex}

% \section{Current Operator in Landau Levels}
% \input{sections/6_current_operator.tex}

\section{Floquet-Drude Conductivity in Quantum Hall Systems}
\input{sections/7_floquet_drude_conductivity.tex}

\section{Manipulate Conductivity in Quantum Hall System}
\input{sections/8_manipulate_conductivity.tex}
