...
\begin{equation} \label{4.31}
  \begin{aligned}
    ...
    \sum_{i=1}^{N_{imp}}
    \int_{-\infty}^{\infty} dy\;
    \frac{1}{\sqrt{L_y}} e^{ik'_y y} \delta(y-y_i) \frac{1}{\sqrt{L_y}} e^{-i{k}_y y}
    \mel**{k'_x}{\Upsilon_{imp} \delta(x-x_i)}{k_x} \\
    &=
    \sum_{i=1}^{N_{imp}} \frac{1}{{L_y}}
    e^{i(k'_y - k_y )y}
    \mel**{k'_x}{\Upsilon_{imp} \delta(x-x_i)}{k_x}
  \end{aligned}
\end{equation}
...
\begin{equation} \label{4.32}
  \begin{aligned}
    ...
    & =
    V_{k'_x,k_x}
    \frac{N_{imp}}{L_y^2} \int_{-\infty}^{\infty} dy_i\;
...
\begin{equation} \label{4.33}
  ...
  \mel**{k'_x}{\Upsilon_{imp} \delta(x-x_i)}{k_x}
\end{equation}
is constant value for every $i$ impurity and $\eta_{imp}$ is number of impurities in a unit area.\\
