...
In contrast to the MIRO analysis \cite{dmitriev03,dmitriev05,dmitriev09}, we consider the dressed quantum Hall system under the off-resonant condition, but photon absorption does not happen. Therefore, we can select the Fermi-Dirac distribution as our particle distribution function for Eq.~[31]
\begin{equation} \tag{5}
